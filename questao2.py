...
if salario > 1500 :
    valor_total = ((salario * 0.5) + salario)
    print("O percentual de aumento foi de 5%")
print("O salario apos o aumento e" ,valor_total,)
print("O salario antes do reajuste e" ,salario,)
print("O valor do aumento e de", valor_total - salario,)
print("O novo salario vai ser" , valor_total)
